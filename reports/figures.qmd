...
# Derive variant mod_names preserving correct suffix order (_2025 last)
year_suffix    = if(last_year == 2025) paste0("_", last_year) else ""
mod_name_base  = sub("_2025$", "", mod_name)  # strip year suffix if present
mod_name_swiss    = paste0(mod_name_base, "_swiss",     year_suffix)
mod_name_nonswiss = paste0(mod_name_base, "_non-swiss", year_suffix)
mod_name_first    = paste0(mod_name_base, "_first",     year_suffix)
mod_name_second   = paste0(mod_name_base, "_second",    year_suffix)
```
