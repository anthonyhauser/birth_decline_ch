...
#gp_df = readRDS(paste0(code_root_path,res_path,save.date,"_",mod_name_full,"_seedid",seed_id,"_gp.RDS"))
gp_rel_df = readRDS(paste0(code_root_path,res_path,save.date,"_",mod_name_full,"_seedid",seed_id,"_gp_rel.RDS"))
#age_bias_df = readRDS(paste0(code_root_path,res_path,save.date,"_",mod_name_full,"_seedid",seed_id,"_agebias.RDS"))
#pred_df = readRDS(paste0(code_root_path,res_path,save.date,"_",mod_name_full,"_seedid",seed_id,"_pred.RDS"))
...
#excess_birth_reg_df = readRDS(paste0(code_root_path,res_path,save.date,"_",mod_name_full,"_","seedid",seed_id,"_","excess_birth_reg_df",".RDS"))
#excess_birth_year_reg_df = readRDS(paste0(code_root_path,res_path,save.date,"_",mod_name_full,"_","seedid",seed_id,"_","excess_birth_year_reg_df",".RDS"))

#excess by citizenship
if(filter_ctz2=="all"){
  #excess_birth_year_ctz_df = readRDS(paste0(code_root_path,res_path,save.date,"_",mod_name_full,"_","seedid",seed_id,"_","excess_birth_year_ctz_df",".RDS"))
  #excess_birth_year_age_ctz_df = readRDS(paste0(code_root_path,res_path,save.date,"_",mod_name_full,"_","seedid",seed_id,"_","excess_birth_year_age_ctz_df",".RDS"))
  #excess_birth_year_month_ctz_df = readRDS(paste0(code_root_path,res_path,save.date,"_",mod_name_full,"_","seedid",seed_id,"_","excess_birth_year_month_ctz_df",".RDS"))
}

#excess by municipality
#excess_birth_mun_df = readRDS(paste0(code_root_path,res_path,save.date,"_",mod_name_full,"_","seedid",seed_id,"_","excess_birth_mun_df",".RDS"))
excess_birth_adj2_mun_df = readRDS(paste0(code_root_path,res_path,save.date,"_",mod_name_full,"_","seedid",seed_id,"_","excess_birth_adj2_mun_df",".RDS"))
# if(filter_parity!="all"){
#   excess_birth_adj2_mun_childless_df = readRDS(paste0(code_root_path,res_path,save.date,"_",mod_name_full,"_childless","_","seedid",seed_id,"_","excess_birth_adj2_mun_df",".RDS"))
# }
#excess_birth_year_mun_df = readRDS(paste0(code_root_path,res_path,save.date,"_",mod_name_full,"_","seedid",seed_id,"_","excess_birth_year_mun_df",".RDS"))
#excess_birth_year_adj2_mun_df = readRDS(paste0(code_root_path,res_path,save.date,"_",mod_name_full,"_","seedid",seed_id,"_","excess_birth_year_adj2_mun_df",".RDS"))
...
#excess_birth_ctzreg_ctn_df = readRDS(paste0(code_root_path,res_path,save.date,"_",mod_name_full,"_","seedid",seed_id,"_","excess_birth_ctzreg_ctn_df",".RDS"))
